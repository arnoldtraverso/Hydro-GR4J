...
```{r}
MNT_utm <- projectRaster(MNT, crs = crs(""))
...
rsaga.geoprocessor(lib = "io_gdal", 0,
                   param = list(GRIDS ="MNT_utm_sgrd",
                                FILES= "MNT_utm.tif",
                                TRANSFORM= 1),env = envi)

#Verificar que quedó creado
MNT_utm_sgrd = raster("MNT_utm_sgrd.sdat")
...
rsaga.geoprocessor(lib = "ta_preprocessor", 2,
                   param = list(DEM ="MNT_utm_sgrd.sgrd",
